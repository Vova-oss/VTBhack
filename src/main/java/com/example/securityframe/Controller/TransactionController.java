...
public class TransactionController {
    ...
    @ApiOperation(value = "Получение топ категорий трат по сотруднику")
    @GetMapping("/topSpendingCategoriesByWorker")
    ...
    @ApiOperation(value = "Получение графика расходов")
    @GetMapping("/expenseSchedule")
    public List<OneDay> expenseSchedule(
            @ApiParam(
                    name = "from",
                    value = "Период от (включительно)",
                    example = "2021-11-29"
